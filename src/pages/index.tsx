	...
	<body className="home">
		<header className="hd-bar">
			<div className="hd-ctn">
	    		<div className="hd-logo">
      				<Link href="/">
	        			<Image src={SstuneLogo_w} alt="SStune" />
					</Link>
    			</div>
					...
					<div className="openbtn-box">
						<div className="openbtn-ctn">
							<nav>
								...
								<div className="nav-logo"><Link href="index.html"><Image src={SstuneLogo_bk} alt="SStune" /></Link></div>
							</nav>
						</div>
					</div>
				</div>
		...
		<div className="hero" id="top">
			<div className="hero-ctn">
				...
				<div className="catchcopy"><h1><Image src={CatchCopy} alt="" /></h1></div>
						...
						<Link href="works.html">
							<div className="slider">
								<ul className="slider-l">
									<li className="slider-item slider-item01"><Image src="/images/mockup_1.jpg" height={900} width={600} alt="" /></li>
									<li className="slider-item slider-item01"><Image src="/images/mockup_2.jpg" height={900} width={600} alt="" /></li>
									<li className="slider-item slider-item01"><Image src="/images/mockup_3.jpg" height={900} width={600} alt="" /></li>
								</ul>
								<ul className="slider-r" dir="rtl">
									<li className="slider-item slider-item04"><Image src="/images/mockup_3.jpg" height={900} width={600} alt="" /></li>
									<li className="slider-item slider-item05"><Image src="/images/mockup_4.jpg" height={900} width={600} alt="" /></li>
									<li className="slider-item slider-item06"><Image src="/images/mockup_5.jpg" height={900} width={600} alt="" /></li>
								</ul>
							</div>
						</Link>
					</div>
